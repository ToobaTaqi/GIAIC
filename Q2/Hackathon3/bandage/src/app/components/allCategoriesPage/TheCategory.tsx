...
export default function TheCategory() {
  ...
  return (
    <section className="w-[85vw] lg:w-[73vw] mx-auto py-[48px] flex flex-col gap-[30px]">
      <div className="flex flex-col gap-[30px] lg:w-[510px] lg:h-[546px]">
      ...
      <div className="w-full lg:w-[510px] px-[24px] flex flex-col lg:flex-row lg:flex-wrap gap-[20px]">
